...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    // <aside
    //   ref={sidebar}
    //   style={{borderWidth: '1px', borderRadius: '30px', borderColor: "#9f9c9c"}}
    ...
    // >
    //   {/* <!-- SIDEBAR HEADER --> */}
    //   <div className="flex items-center justify-between gap-2 px-6 pt-5.5 lg:py-2.5">
    //     {/* <NavLink to="/">
    //       <img src={Logo} alt="Logo" />
    //     </NavLink> */}
    //       <div className="flex rounded-full">
    //           <NavLink to="/">
    //               {/* <img className="h-20 w-55 lg:h-20 lg:w-55 rounded-full bg-white  " src={logo} alt="Logo" /> */}
    //               <img className="h-15 w-35 lg:h-20 lg:w-25 md:h-12 md:w-20 rounded-3xl bg-white  " src={logo} alt="Logo" />
    //           </NavLink>
    //       </div>
    //     <button
    //       ref={trigger}
    ...
    //                   <NavLink
    //                     to="#"
    //                     className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-black hover:text-white hover:rounded-2xl dark:hover:bg-meta-4 ${
    //                       (pathname === '/' ||
    //                         pathname.includes('dashboard')) &&
    //                         // 'bg-violet-800 dark:bg-meta-4'
    //                       'bg-graydark dark:bg-meta-4 text-white rounded-2xl	'
    //                     }`}
    //                     onClick={(e) => {
    //                       e.preventDefault();
    //                       sidebarExpanded
    ...
    //                           className={({ isActive }) =>
    //                             'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-boxdark-2 duration-300 ease-in-out hover:text-black ' +
    //                             (isActive && '!text-boxdark-2 !font-bold')
    //                             // '!text-white'
    //                           }
    //                         >
    //                           ECommerce
    ...
    //             <NavLink
    //               to="/calendar"
    //               className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-violet-800 dark:hover:bg-meta-4 ${
    ...
    //                   <NavLink
    //                     to="#"
    //                     className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-violet-800 dark:hover:bg-meta-4 ${
        ...
        {/* <div> */}
          ...
          <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {(handleClick, open) => {
                ...
                return (
                  <React.Fragment>
                    <NavLink
                      to="#"
                      className={`group relative flex items-center gap-2.5  text-size px-4 py-2 font-medium lg:text-black  duration-300 ease-in-out hover:bg-black hover:text-white hover:rounded-2xl dark:hover:bg-meta-4 ${
                        (pathname === '/' ||
                          pathname.includes('dashboard')) &&
                          // 'bg-violet-800 dark:bg-meta-4'
                        'bg-graydark dark:bg-meta-4 text-white  rounded-2xl	'
            ...
            <li>
              <NavLink
                to="/calendar"
                className={`group relative  fond-medium flex rounded-2xl items-center gap-2.5 py-2 px-4 duration-300 ease-in-out lg:text-boxdark-2 hover:bg-black hover:text-white hover:rounded-2xl dark:hover:bg-meta-4 ${
                  pathname.includes('calendar') &&
                  //  'bg-violet-800 dark:bg-meta-4'
