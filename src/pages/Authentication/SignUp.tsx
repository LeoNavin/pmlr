      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-15.5 px-26 text-center">
              <Link className="mb-4.5 inline-block" to="/">
                <img className="hidden dark:block" src={logo3} alt="Logo" />
                <img className="dark:hidden bg-blue-400 rounded-full" src={logo3} alt="Logo" />
              </Link>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h4 className="mb-4 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to PMLRA
              </h4>
